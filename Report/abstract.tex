...
We show the performance of a connectionist Q-Learning algorithm with a target network and experience replay, and compare it to three more implementations. One that uses the on-policy algorithm SARSA, one with the addition of a duelling network architecture and one with both modifications.
